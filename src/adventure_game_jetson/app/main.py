...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--edge-sio-url", default="")
    ...
    parser.add_argument("--edge-video-width", type=int, default=0)
    parser.add_argument("--edge-video-height", type=int, default=0)
    ...
    parser.add_argument("--edge-preview-width", type=int, default=640)
